...
-- sql = { driver = "PostgreSQL", database = "prosody", username = "prosody", password = "pass", host = "prosody-db" }
...
VirtualHost "private.marsha"
    authentication = "internal_hashed"
    admins = { "marsha@private.marsha" }
...
Component "conference.marsha" "muc"
